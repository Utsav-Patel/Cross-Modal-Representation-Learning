...
if mp.cpu_count() >= 10:
    ...
    TRAIN_TEXT_PATH = "/freespace/local/as3503/536/embeddings_mean/text_" + TEXT_ELEMENT + "_train_embeddings.pkl"
    VALIDATION_TEXT_PATH = "/freespace/local/as3503/536/embeddings_mean/text_" + TEXT_ELEMENT + "_val_embeddings.pkl"
    TEST_TEXT_PATH = "/freespace/local/as3503/536/embeddings_mean/text_" + TEXT_ELEMENT + "_test_embeddings.pkl"
