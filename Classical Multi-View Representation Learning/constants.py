...
if mp.cpu_count() >= 10:
    TRAIN_IMAGE_PATH = "/freespace/local/as3503/536/embeddings/image_train_embeddings.pkl"
    VALIDATION_IMAGE_PATH = "/freespace/local/as3503/536/embeddings/image_val_embeddings.pkl"
    TEST_IMAGE_PATH = "/freespace/local/as3503/536/embeddings/image_test_embeddings.pkl"

    TRAIN_TEXT_PATH = "/freespace/local/as3503/536/entire/embeddings_all_mean/text_" + TEXT_ELEMENT + "_train_embeddings.pkl"
    VALIDATION_TEXT_PATH = "/freespace/local/as3503/536/entire/embeddings_all_mean/text_" + TEXT_ELEMENT + "_val_embeddings.pkl"
    TEST_TEXT_PATH = "/freespace/local/as3503/536/entire/embeddings_all_mean/text_" + TEXT_ELEMENT + "_test_embeddings.pkl"
